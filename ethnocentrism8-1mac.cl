...
(defun run (ncycles lastn nruns &optional (size 10) (ntags 8) (nstrategies 2) (cost 0.01) (benefit 0.03) 
...
Run ncycles & analyze last lastn cycles for nruns & other optional parameters."
  (setq *path* "/Users/christinaisaicu/Documents/0McGill/u3/FALL2018/PSYC315/ethnocentrism/code/10x10/8-tag/run-1000-100-10/")
  (seed-random)
...
(defun run-all-strategies (ncycles nruns overall top2 &optional (size 10) (ntags 8) (nstrategies 2) 
...
overall is critical value for overall x^2. 
top2 is critical value for most frequent vs next most frequent x^2."
  (setq *path* "/Users/christinaisaicu/Documents/0McGill/u3/FALL2018/PSYC315/ethnocentrism/code/10x10/8-tag/run-all-s-1000-10-11_35_6_64/")
  (seed-random)
  (set-parameters ntags nstrategies cost benefit base-ptr mutation-rate death-rate immigration-rate)
  (list-parameters)
  (do ((i 0 (1+ i)))
...
(defun run1plots (ncycles nth &optional (size 10) (ntags 8) (nstrategies 2) (cost 0.01) 
...
Run ncycles & plot every nth cycle for torus of size."
  (setq *path* "/Users/christinaisaicu/Documents/0McGill/u3/FALL2018/PSYC315/ethnocentrism/test/")
  (seed-random)
  (set-parameters ntags nstrategies cost benefit base-ptr mutation-rate death-rate immigration-rate)
  (initialize-torus size)
  (do ((i 1 (1+ i))
