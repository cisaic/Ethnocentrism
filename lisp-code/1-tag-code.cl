...
;;;programmer: Tom Shultz, modified by Christina Isaicu
;;;started: 31 aug 2007
;;;current: 28 nov 2018
...
Run ncycles & plot every nth cycle for torus of size."
  (setq *path* "/Users/christinaisaicu/Documents/0McGill/u3/FALL2018/PSYC315/ethnocentrism/code/10x10/1-tag/run1plots-1000-100/")
  (seed-random)
  (set-parameters ntags nstrategies cost benefit base-ptr mutation-rate death-rate immigration-rate)
  (initialize-torus size)
  (do ((i 1 (1+ i))
