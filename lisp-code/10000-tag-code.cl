...
Run ncycles & analyze last lastn cycles for nruns & other optional parameters."
  (setq *path* "/Users/christinaisaicu/Documents/0McGill/u3/FALL2018/PSYC315/ethnocentrism/code/50x50/1000-tag/run-1000-100-10/")
  (seed-random)
...
overall is critical value for overall x^2. 
top2 is critical value for most frequent vs next most frequent x^2."
  (setq *path* "/Users/christinaisaicu/Documents/0McGill/u3/FALL2018/PSYC315/ethnocentrism/code/50x50/1000-tag/run-all-s-1000-10-11_35_6_64/")
  (seed-random)
  (set-parameters ntags nstrategies cost benefit base-ptr mutation-rate death-rate immigration-rate)
  (list-parameters)
  (do ((i 0 (1+ i)))
...
;(run 1000 100 10 50 100000)
;(run-all-strategies 1000 10 11.35 6.64 50 100000)
