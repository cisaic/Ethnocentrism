...
To ensure the 'uniqueness' of each agent, the in-group/out-group (igs, ogs) mutation probability of offspring from 0.005 to 1, so there is a 100% chance the offspring has a different tag than its parent. 
